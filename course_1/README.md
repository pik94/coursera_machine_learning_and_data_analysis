...
### Неделя 1: Введение
Задачи:
* Установка Python -> week_1/install_python

### Неделя 2: Библиотеки Python и линейная алгебра
Задачи:
* Линейная алгебра: сходство текстов и аппроксимация функций -> week_2/linear_algebra

### Неделя 3: Оптимизация и матричные разложения
Задачи:
* Оптимизация в Python: глобальная оптимизация и оптимизация негладкой функции -> week_3/optimization_in_python

### Неделя 4: Случайность
Задачи:
* Центральная предельная теорема своими руками -> week_4/statistics